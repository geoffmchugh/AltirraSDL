...
| Role | Path (example)                         |
|------|----------------------------------------|
| OLD  | `../Altirra-4.50-test17-src` (last synced release)  |
| NEW  | `../Altirra-4.50-test18-src` (target release)       |
...
./tools/sync_diff.sh \
    --old  ../../Altirra-4.50-test17-src \
    --new  ../../Altirra-4.50-test18-src \
    --fork ../
