...
//
// Fonts generated by TTE use an em square size of 1024 units and can have
...
public:
	...
	// Note that glyph 0 is the default / missing glyph. It must be non-empty.
	ATTrueTypeGlyphIndex BeginSimpleGlyph();

	// Add a contour for a circle, using 8 quadratic curves.
	void AddCircleContour(sint32 cx, sint32 cy, sint32 r);
	...
	// Set the advance width for the current glyph. This has priority over the default
	// advance width.
	void SetGlyphAdvanceWidth(sint32 advanceUnits);
...
private:
	...
	vdfastvector<uint8> mGlyphBuffer;
	vdfastvector<uint32> mGlyphOffsets;
	bool mNeedLongGlyphOffsets = false;
