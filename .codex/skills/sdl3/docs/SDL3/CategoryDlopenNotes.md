...
If you determine that your toolchain doesn't support dlopen notes,
you can disable this feature by defining [SDL_DISABLE_DLOPEN_NOTES](SDL_DISABLE_DLOPEN_NOTES).
You can use this CMake snippet to check for support:
