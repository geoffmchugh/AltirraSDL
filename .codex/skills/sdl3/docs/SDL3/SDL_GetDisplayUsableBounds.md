...
| --- | --- | --- |
| SDL_Rect* | rect | theSDL_Rectstructure filled in with
the display bounds. |
...
This is the same area as [SDL_GetDisplayBounds](SDL_GetDisplayBounds)() reports, but
with portions reserved by the system removed. For example, on Apple's
