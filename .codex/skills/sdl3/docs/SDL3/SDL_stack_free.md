...
| data | the pointer, fromSDL_stack_alloc(), to free. |
| --- | --- |
...
function that called [SDL_stack_alloc](SDL_stack_alloc)() returns. If SDL used
[SDL_malloc](SDL_malloc)(), it will [SDL_free](SDL_free) the memory immediately.
