...
| int * | num_formats | a pointer filled with the number of supported XR swapchain
formats. |
...
information. This should be freed with [SDL_free](SDL_free)() when it is no longer needed.
