...
| bool | populated | true to initialize it from the C runtime environment, false to
...
pointer to the new environment or NULL on failure; call [SDL_GetError](SDL_GetError)() for more information.
