...
Set fragment shader uniform variables in a custom GPU render
state.
...
The data is copied and will be pushed using [SDL_PushGPUFragmentUniformData](SDL_PushGPUFragmentUniformData)()
