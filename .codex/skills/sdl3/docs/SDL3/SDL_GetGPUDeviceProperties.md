...
All properties are optional and may differ between GPU backends and
SDL versions.
...
introduced, or when SDL adds new GPU backends or modifies existing
ones.
...
is a relatively short version string in an unspecified format. If [SDL_PROP_GPU_DEVICE_DRIVER_INFO_STRING](SDL_PROP_GPU_DEVICE_DRIVER_INFO_STRING)
...
preferred over [SDL_PROP_GPU_DEVICE_DRIVER_VERSION_STRING](SDL_PROP_GPU_DEVICE_DRIVER_VERSION_STRING)
...
This string has also been observed to be a multiline string (which
