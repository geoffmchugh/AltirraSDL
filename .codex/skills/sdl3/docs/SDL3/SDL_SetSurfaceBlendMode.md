...
update. |
| --- | --- | --- |
| SDL_BlendMode | blendMode | theSDL_BlendModeto use for blit
blending. |
...
with the existing data, the blendmode of the SOURCE surface should be
set to [SDL_BLENDMODE_NONE](SDL_BLENDMODE_NONE).
