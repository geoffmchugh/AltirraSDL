...
Once set, this metadata can be read using [SDL_GetAppMetadataProperty](SDL_GetAppMetadataProperty)().
...
"1.0.3beta2" and "April 22nd, 2024" and a git hash are all valid
