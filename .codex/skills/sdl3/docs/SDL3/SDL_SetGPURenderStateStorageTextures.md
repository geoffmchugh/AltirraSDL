...
| SDL_GPUTexture*const * | storage_textures | Storage textures to bind. |
...
The data is copied and will be binded using [SDL_BindGPUFragmentStorageTextures](SDL_BindGPUFragmentStorageTextures)()
