...
| constSDL_GPUTextureSamplerBinding* | sampler_bindings | Additional fragment samplers to bind. |
...
The data is copied and will be binded using [SDL_BindGPUFragmentSamplers](SDL_BindGPUFragmentSamplers)()
