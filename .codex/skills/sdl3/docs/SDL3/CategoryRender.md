...
The primitives may be drawn in opaque, blended, or additive
modes.

The texture images may be drawn in opaque, blended, or additive
modes. They can have an additional color tint or alpha modulation
applied to them, and may also be stretched with linear
interpolation.
...
details: [https://github.com/libsdl-org/SDL/issues/986](https://github.com/libsdl-org/SDL/issues/986)
