...
| SDL_Environment* | env | the environment to query. |
| --- | --- | --- |

## Return Value

(char **) Returns a NULL terminated array of pointers to environment
variables in the form "variable=value" or NULL on failure; call [SDL_GetError](SDL_GetError)() for more information. This
