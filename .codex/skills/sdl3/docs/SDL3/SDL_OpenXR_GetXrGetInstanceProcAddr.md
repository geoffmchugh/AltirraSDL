...
Get the address of the `xrGetInstanceProcAddr`
function.
...
`xrGetInstanceProcAddr` or NULL on failure; call [SDL_GetError](SDL_GetError)() for more information.

## Remarks

This should be called after either calling [SDL_OpenXR_LoadLibrary](SDL_OpenXR_LoadLibrary)() or
creating an OpenXR [SDL_GPUDevice](SDL_GPUDevice).
