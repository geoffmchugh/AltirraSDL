...
update. |
| --- | --- | --- |
| SDL_Surface* | image | a pointer to an alternateSDL_Surfaceto associate with this surface. |
...
This function adds a reference to the alternate version, so you
should call [SDL_DestroySurface](SDL_DestroySurface)()
on the image after this call.
