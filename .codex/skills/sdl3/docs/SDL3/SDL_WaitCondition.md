...
condition variable `cond`. Once the condition variable is
...
This function is the equivalent of calling [SDL_WaitConditionTimeout](SDL_WaitConditionTimeout)() with
a time length of -1.
