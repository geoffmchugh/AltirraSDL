...
(void *) Returns the jobject representing the instance of the
Activity class of the Android application, or NULL on failure; call [SDL_GetError](SDL_GetError)() for more information.
...
[https://docs.oracle.com/javase/1.5.0/docs/guide/jni/spec/functions.html](https://docs.oracle.com/javase/1.5.0/docs/guide/jni/spec/functions)
