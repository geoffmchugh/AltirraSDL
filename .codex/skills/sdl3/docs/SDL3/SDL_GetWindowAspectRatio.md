...
| SDL_Window* | window | the window to query the width and height from. |
| --- | --- | --- |
| float * | min_aspect | a pointer filled in with the minimum aspect ratio of the window, may
be NULL. |
| float * | max_aspect | a pointer filled in with the maximum aspect ratio of the window, may
be NULL. |
