...
SDL port for QNX, providing both screen and Wayland video
backends.
...
You can find the cross-compiled build tools at [https://github.com/qnx-ports/build-files](https://github.com/qnx-ports/build-files)
...
- Restraining the mouse to a window or warping the mouse cursor will
not work.
