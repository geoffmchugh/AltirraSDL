...
([SDL_GPUDevice](SDL_GPUDevice) *) Returns the GPU
device used by the renderer, or NULL if the renderer is not a GPU
renderer; call [SDL_GetError](SDL_GetError)() for more
information.
