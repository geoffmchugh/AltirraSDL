...
This function does the same thing as [SDL_CreateTrayMenu](SDL_CreateTrayMenu), except that it
takes a [SDL_TrayEntry](SDL_TrayEntry) instead of a [SDL_Tray](SDL_Tray).
