...
Convert from an [SDL_GamepadButton](SDL_GamepadButton) enum to a
string.
...
| SDL_GamepadButton | button | an enum value for a givenSDL_GamepadButton. |
| --- | --- | --- |
...
by [SDL_Gamepad](SDL_Gamepad) mapping strings.
