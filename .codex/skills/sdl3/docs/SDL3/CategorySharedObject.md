...
To use them, build such a library, then call [SDL_LoadObject](SDL_LoadObject)() on it. Once loaded, you
can use [SDL_LoadFunction](SDL_LoadFunction)() on that
object to find the address of its exported symbols. When done with the
object, call [SDL_UnloadObject](SDL_UnloadObject)() to
dispose of it.
...
- Once a library is unloaded, all pointers into it obtained through [SDL_LoadFunction](SDL_LoadFunction)() become invalid, even
