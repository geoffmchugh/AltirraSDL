...
([SDL_Surface](SDL_Surface) *) Returns the surface
associated with the window, or NULL on failure; call [SDL_GetError](SDL_GetError)() for more information.
...
This function is affected by [SDL_HINT_FRAMEBUFFER_ACCELERATION](SDL_HINT_FRAMEBUFFER_ACCELERATION).
