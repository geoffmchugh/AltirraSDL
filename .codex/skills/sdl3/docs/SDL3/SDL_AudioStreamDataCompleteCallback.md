...
A callback that fires for completed [SDL_PutAudioStreamDataNoCopy](SDL_PutAudioStreamDataNoCopy)()
data.
...
| --- | --- |
| buf | the pointer provided toSDL_PutAudioStreamDataNoCopy(). |
| buflen | the size of buffer, in bytes, provided toSDL_PutAudioStreamDataNoCopy(). |
