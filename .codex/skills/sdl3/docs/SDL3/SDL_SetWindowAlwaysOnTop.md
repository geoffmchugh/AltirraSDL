...
| SDL_Window* | window | the window of which to change the always on top state. |
| --- | --- | --- |
...
This will add or remove the window's [SDL_WINDOW_ALWAYS_ON_TOP](SDL_WINDOW_ALWAYS_ON_TOP)
