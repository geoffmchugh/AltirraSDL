...
| x | the byte count to align to, so the data's address will be a multiple
of this value. |
| --- | --- |
...
allocate something that respects this alignment, use [SDL_aligned_alloc](SDL_aligned_alloc)() or some other
mechanism.
