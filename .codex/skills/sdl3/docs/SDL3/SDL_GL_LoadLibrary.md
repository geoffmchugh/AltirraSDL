...
| const char * | path | the platform dependent OpenGL library name, or NULL to open the
...
your program from the dynamic library using [SDL_GL_GetProcAddress](SDL_GL_GetProcAddress)().
