...
rendering target in pixels, otherwise return the value of [SDL_GetRenderOutputSize](SDL_GetRenderOutputSize)().

Rendering target or not, the output will be adjusted by the current
logical presentation state, dictated by [SDL_SetRenderLogicalPresentation](SDL_SetRenderLogicalPresentation)().
