...
| --- | --- | --- |
| SDL_Surface* | icon | anSDL_Surfacestructure containing
...
added using [SDL_AddSurfaceAlternateImage](SDL_AddSurfaceAlternateImage)(),
...
DPI situations. For example, if the original surface is 32x32, then on a
