...
| SDL_Haptic* | haptic | theSDL_Hapticdevice to set the gain
on. |
| --- | --- | --- |
| int | gain | value to set the gain to, should be between 0 and 100 (0 -
100). |
...
variable [SDL_HAPTIC_GAIN_MAX](SDL_HAPTIC_GAIN_MAX)
which should be between 0 and 100. All calls to [SDL_SetHapticGain](SDL_SetHapticGain)() will scale
linearly using [SDL_HAPTIC_GAIN_MAX](SDL_HAPTIC_GAIN_MAX) as
the maximum.
