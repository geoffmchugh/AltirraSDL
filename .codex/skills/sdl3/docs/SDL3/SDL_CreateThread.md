...
| SDL_ThreadFunction | fn | theSDL_ThreadFunctionfunction to call in the new thread. |
| --- | --- | --- |
| const char * | name | the name of the thread. |
| void * | data | a pointer that is passed tofn. |
...
This is a convenience function, equivalent to calling [SDL_CreateThreadWithProperties](SDL_CreateThreadWithProperties)
