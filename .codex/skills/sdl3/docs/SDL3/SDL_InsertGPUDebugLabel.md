...
On Direct3D 12, using [SDL_InsertGPUDebugLabel](SDL_InsertGPUDebugLabel) requires
WinPixEventRuntime.dll to be in your PATH or in the same directory as
your executable. See [here](https://devblogs.microsoft.com/pix/winpixeventruntime/)
