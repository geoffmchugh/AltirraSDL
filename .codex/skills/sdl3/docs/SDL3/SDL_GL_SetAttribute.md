...
| SDL_GLAttr | attr | an enum value specifying the OpenGL attribute to set. |
| --- | --- | --- |
...
This function sets the OpenGL attribute `attr` to
`value`. The requested attributes should be set before
creating an OpenGL window. You should use [SDL_GL_GetAttribute](SDL_GL_GetAttribute)() to check the
