...
For the most part, Vulkan operates independent of SDL, but it
benefits from a little support during setup.
...
will get you the final pieces you need to prepare for rendering into an
...
provide Vulkan equivalents of [SDL_GL_SwapWindow](SDL_GL_SwapWindow)(), etc; they aren't
necessary.
