...
| SDL_Joystick* | joystick | theSDL_Joystickto create a haptic
device from. |
| --- | --- | --- |

## Return Value

([SDL_Haptic](SDL_Haptic) *) Returns a valid haptic
device identifier on success or NULL on failure; call [SDL_GetError](SDL_GetError)() for more information.
