...
| --- | --- | --- |
| XrSwapchain | swapchain | a swapchain previously returned bySDL_CreateGPUXRSwapchain. |
| SDL_GPUTexture** | swapchainImages | an array of swapchain images returned by the same call toSDL_CreateGPUXRSwapchain. |
