...
| SDL_Surface* | surface | theSDL_Surfacestructure to be
clipped. |
| --- | --- | --- |
| constSDL_Rect* | rect | theSDL_Rectstructure representing the
clipping rectangle, or NULL to disable clipping. |

## Return Value

(bool) Returns true if the rectangle intersects the surface,
