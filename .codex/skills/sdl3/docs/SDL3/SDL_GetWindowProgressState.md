...
| SDL_Window* | window | the window to get the current progress state from. |
| --- | --- | --- |

## Return Value

([SDL_ProgressState](SDL_ProgressState)) Returns the
progress state, or [SDL_PROGRESS_STATE_INVALID](SDL_PROGRESS_STATE_INVALID)
