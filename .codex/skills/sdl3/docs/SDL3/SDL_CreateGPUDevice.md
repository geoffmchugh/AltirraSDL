...
| SDL_GPUShaderFormat | format_flags | a bitflag indicating which shader formats the app is able to
provide. |
| --- | --- | --- |
| bool | debug_mode | enable debug mode properties and validations. |
| const char * | name | the preferred GPU driver, or NULL to let SDL pick the optimal
driver. |
