...
Use this function to create a new [SDL_AsyncIO](SDL_AsyncIO) object for reading from and/or
...
([SDL_AsyncIO](SDL_AsyncIO) *) Returns a pointer to
the [SDL_AsyncIO](SDL_AsyncIO) structure that is created
...
mode for appending, since you specify the position when starting a
task.
...
This call is *not* asynchronous; it will open the file before
