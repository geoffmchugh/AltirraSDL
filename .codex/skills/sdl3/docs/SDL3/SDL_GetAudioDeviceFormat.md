...
| int * | sample_frames | pointer to store device buffer size, in sample frames. Can be
NULL. |
...
You may also specify [SDL_AUDIO_DEVICE_DEFAULT_PLAYBACK](SDL_AUDIO_DEVICE_DEFAULT_PLAYBACK)
