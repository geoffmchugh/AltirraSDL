...
query. |
| --- | --- | --- |
| SDL_AudioSpec* | src_spec | where to store the input audio format; ignored if NULL. |
| SDL_AudioSpec* | dst_spec | where to store the output audio format; ignored if NULL. |
