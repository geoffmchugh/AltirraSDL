...
| --- | --- | --- |
| constSDL_GPUTextureRegion* | source | the source texture region. |
| constSDL_GPUTextureTransferInfo* | destination | the destination transfer buffer with image layout information. |
