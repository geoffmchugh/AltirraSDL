...
Macro that annotates function params with output string buffer
size.
...
This notes that `text` is a null-terminated C string,
should be `maxlen` bytes in size, and is only written to by
