...
| SDL_Renderer* | renderer | the renderer to update. |
| --- | --- | --- |
| SDL_ScaleMode | scale_mode | the scale mode to change to for new textures. |
...
When a renderer is created, scale_mode defaults to [SDL_SCALEMODE_LINEAR](SDL_SCALEMODE_LINEAR).
