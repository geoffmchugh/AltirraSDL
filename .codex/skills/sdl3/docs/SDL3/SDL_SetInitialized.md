...
This function sets the status of the passed in state to [SDL_INIT_STATUS_INITIALIZED](SDL_INIT_STATUS_INITIALIZED)
or [SDL_INIT_STATUS_UNINITIALIZED](SDL_INIT_STATUS_UNINITIALIZED)
