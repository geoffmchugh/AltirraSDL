...
| int | finger | a finger. |
| bool * | down | a pointer filled with true if the finger is down, false otherwise,
may be NULL. |
| float * | x | a pointer filled with the x position, normalized 0 to 1, with the
origin in the upper left, may be NULL. |
| float * | y | a pointer filled with the y position, normalized 0 to 1, with the
origin in the upper left, may be NULL. |
