...
| SDL_SharedObject* | handle | a valid shared object handle returned bySDL_LoadObject(). |
| --- | --- | --- |
...
a pointer to the function or NULL on failure; call [SDL_GetError](SDL_GetError)() for more information.

## Remarks

This function pointer is no longer valid after calling [SDL_UnloadObject](SDL_UnloadObject)().
