...
Get the number of effects a haptic device can play at the same
time.
...
| SDL_Haptic* | haptic | theSDL_Hapticdevice to query maximum
playing effects. |
| --- | --- | --- |
...
same time or -1 on failure; call [SDL_GetError](SDL_GetError)() for more information.
