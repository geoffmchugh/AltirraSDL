...
Set an atomic variable to a new value if it is currently an old
value.
...
| SDL_AtomicU32* | a | a pointer to anSDL_AtomicU32variable to be modified. |
| --- | --- | --- |
...
(bool) Returns true if the atomic variable was set, false
otherwise.
