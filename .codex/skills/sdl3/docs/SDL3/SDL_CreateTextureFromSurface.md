...
pixel data used to fill the texture. |
...
The [SDL_TextureAccess](SDL_TextureAccess) hint for
the created texture is [SDL_TEXTUREACCESS_STATIC](SDL_TEXTUREACCESS_STATIC).

The pixel format of the created texture may be different from the
pixel format of the surface, and can be queried using the [SDL_PROP_TEXTURE_FORMAT_NUMBER](SDL_PROP_TEXTURE_FORMAT_NUMBER)
property.
