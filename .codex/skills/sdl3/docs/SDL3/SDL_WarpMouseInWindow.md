...
| SDL_Window* | window | the window to move the mouse into, or NULL for the current mouse
focus. |
| --- | --- | --- |
...
warp by setting the [SDL_HINT_MOUSE_RELATIVE_WARP_MOTION](SDL_HINT_MOUSE_RELATIVE_WARP_MOTION)
hint.
