...
This struct is exclusively for the [SDL_HAPTIC_CUSTOM](SDL_HAPTIC_CUSTOM) effect.
...
the data yourself. Data should consist of channels * samples [Uint16](Uint16) samples.

If channels is one, the effect is rotated using the defined
direction. Otherwise it uses the samples in data for the different
axes.
