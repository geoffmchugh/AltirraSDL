...
| constSDL_FColor* | color | vertex colors (asSDL_FColor). |
...
| const void * | indices | (optional) An array of indices into the 'vertices' arrays, if NULL
