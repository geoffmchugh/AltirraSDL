...
| SDL_Surface* | surface | anSDL_Surfacestructure representing
the cursor image. |
| --- | --- | --- |
...
the surface will be interpreted as the content to be used for 100%
display scale, and the alternate representations will be used for high
DPI situations if [SDL_HINT_MOUSE_DPI_SCALE_CURSORS](SDL_HINT_MOUSE_DPI_SCALE_CURSORS)
