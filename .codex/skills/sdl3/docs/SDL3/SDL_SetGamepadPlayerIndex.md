...
| SDL_Gamepad* | gamepad | the gamepad object to adjust. |
| --- | --- | --- |
| int | player_index | player index to assign to this gamepad, or -1 to clear the player
index and turn off player LEDs. |
