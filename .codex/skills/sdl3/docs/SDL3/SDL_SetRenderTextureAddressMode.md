...
| --- | --- | --- |
| SDL_TextureAddressMode | u_mode | theSDL_TextureAddressModeto use for horizontal texture coordinates inSDL_RenderGeometry(). |
| SDL_TextureAddressMode | v_mode | theSDL_TextureAddressModeto use for vertical texture coordinates inSDL_RenderGeometry(). |
