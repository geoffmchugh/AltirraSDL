...
| SDL_Renderer* | renderer | the renderer to get data from. |
| --- | --- | --- |
| SDL_ScaleMode* | scale_mode | aSDL_ScaleModefilled with current
default scale mode. SeeSDL_SetDefaultTextureScaleMode()
