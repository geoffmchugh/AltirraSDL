...
time. Use [SDL_HINT_WAVE_CHUNK_LIMIT](SDL_HINT_WAVE_CHUNK_LIMIT) to
adjust this value.
...
- "ignore" - Ignore the RIFF chunk size and always search up to 4
GiB.

- "maximum" - Search for chunks until the end of file. (not
recommended)
