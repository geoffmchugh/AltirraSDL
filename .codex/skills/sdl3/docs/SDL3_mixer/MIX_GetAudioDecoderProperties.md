...
for a given [MIX_AudioDecoder](MIX_AudioDecoder), if
necessary.

The file-specific metadata exposed through this function is identical
to those available through [MIX_GetAudioProperties](MIX_GetAudioProperties)(). Please
