...
Get the winding order of the vertices returned by [TTF_GetGPUTextDrawData](TTF_GetGPUTextDrawData) for a
...
| constTTF_TextEngine* | engine | aTTF_TextEngineobject created
withTTF_CreateGPUTextEngine(). |
| --- | --- | --- |

## Return Value

([TTF_GPUTextEngineWinding](TTF_GPUTextEngineWinding))
Returns the winding order used by the GPU text engine or [TTF_GPU_TEXTENGINE_WINDING_INVALID](TTF_GPU_TEXTENGINE_WINDING_INVALID)
in case of error.
