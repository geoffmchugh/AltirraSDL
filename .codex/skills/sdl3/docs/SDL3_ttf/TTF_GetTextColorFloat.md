...
| --- | --- | --- |
| float * | r | a pointer filled in with the red color value, normally in the range
of 0-1, may be NULL. |
| float * | g | a pointer filled in with the green color value, normally in the
range of 0-1, may be NULL. |
| float * | b | a pointer filled in with the blue color value, normally in the range
of 0-1, may be NULL. |
| float * | a | a pointer filled in with the alpha value in the range of 0-1, may be
NULL. |
