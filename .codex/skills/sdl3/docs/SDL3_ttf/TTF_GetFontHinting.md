...
| constTTF_Font* | font | the font to query. |
| --- | --- | --- |

## Return Value

([TTF_HintingFlags](TTF_HintingFlags)) Returns the
font's current hinter value, or [TTF_HINTING_INVALID](TTF_HINTING_INVALID) if the font is
invalid.
