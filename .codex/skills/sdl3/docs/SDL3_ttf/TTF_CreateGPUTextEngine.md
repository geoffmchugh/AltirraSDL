...
| SDL_GPUDevice * | device | the SDL_GPUDevice to use for creating textures and drawing
text. |
| --- | --- | --- |

## Return Value

([TTF_TextEngine](TTF_TextEngine) *) Returns a [TTF_TextEngine](TTF_TextEngine) object or NULL on failure;
