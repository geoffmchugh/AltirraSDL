...
| TTF_TextEngine* | engine | the text engine to use when creating the text object, may be
NULL. |
| --- | --- | --- |
...
([TTF_Text](TTF_Text) *) Returns a [TTF_Text](TTF_Text) object or NULL on failure; call
