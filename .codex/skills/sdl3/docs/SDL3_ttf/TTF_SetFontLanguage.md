...
| TTF_Font* | font | the font to specify a language for. |
| --- | --- | --- |
| const char * | language_bcp47 | a null-terminated string containing the desired language's BCP47
code. Or null to reset the value. |
