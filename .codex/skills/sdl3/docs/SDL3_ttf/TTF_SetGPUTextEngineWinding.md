...
Sets the winding order of the vertices returned by [TTF_GetGPUTextDrawData](TTF_GetGPUTextDrawData) for a
...
| TTF_TextEngine* | engine | aTTF_TextEngineobject created
withTTF_CreateGPUTextEngine(). |
| --- | --- | --- |
| TTF_GPUTextEngineWinding | winding | the new winding order option. |
