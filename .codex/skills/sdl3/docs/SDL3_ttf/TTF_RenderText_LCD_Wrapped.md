...
| size_t | length | the length of the text, in bytes, or 0 for null terminated
text. |
| SDL_Color | fg | the foreground color for the text. |
| SDL_Color | bg | the background color for the text. |
| int | wrap_width | the maximum width of the text surface or 0 to wrap on newline
characters. |
...
boundaries if it extends beyond `wrap_width` in pixels.

If wrap_width is 0, this function will only wrap on newline
characters.

You can render at other quality levels with [TTF_RenderText_Solid_Wrapped](TTF_RenderText_Solid_Wrapped),
[TTF_RenderText_Shaded_Wrapped](TTF_RenderText_Shaded_Wrapped),
and [TTF_RenderText_Blended_Wrapped](TTF_RenderText_Blended_Wrapped).
