...
| TTF_SubString* | previous | a pointer filled in with the previous substring in the text
object. |
...
substring with the [TTF_SUBSTRING_TEXT_START](TTF_SUBSTRING_TEXT_START) flag
set.
