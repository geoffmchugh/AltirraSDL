...
| --- | --- | --- |
| int | x | the x coordinate relative to the left side of the text, may be
outside the bounds of the text area. |
| int | y | the y coordinate relative to the top side of the text, may be
outside the bounds of the text area. |
| TTF_SubString* | substring | a pointer filled in with the closest substring of text to the given
point. |
...
This will return the closest substring of text to the given
point.
