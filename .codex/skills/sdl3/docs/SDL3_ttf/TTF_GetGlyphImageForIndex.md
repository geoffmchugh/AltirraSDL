...
| TTF_ImageType* | image_type | a pointer filled in with the glyph image type, may be NULL. |

## Return Value

(SDL_Surface *) Returns an SDL_Surface containing the glyph, or NULL
on failure; call SDL_GetError() for more information.

## Remarks

This is useful for text engine implementations, which can call this
with the `glyph_index` in a [TTF_CopyOperation](TTF_CopyOperation)
