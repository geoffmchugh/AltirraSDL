...
Get the decoder status indicating the current state of the
decoder.
...
Returns the status of the underlying decoder, or [IMG_DECODER_STATUS_INVALID](IMG_DECODER_STATUS_INVALID) if
