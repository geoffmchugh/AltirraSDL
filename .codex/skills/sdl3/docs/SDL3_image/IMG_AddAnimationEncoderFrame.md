...
| IMG_AnimationEncoder* | encoder | the receiving images. |
| --- | --- | --- |
...
units if theIMG_PROP_ANIMATION_ENCODER_CREATE_TIMEBASE_DENOMINATOR_NUMBERproperty is set when creating the encoder. |
