...
Returns a new [IMG_AnimationEncoder](IMG_AnimationEncoder), or NULL on
...
if [IMG_PROP_ANIMATION_ENCODER_CREATE_IOSTREAM_POINTER](IMG_PROP_ANIMATION_ENCODER_CREATE_IOSTREAM_POINTER)
isn't set.
...
closed until the animation encoder is closed. This is required if [IMG_PROP_ANIMATION_ENCODER_CREATE_FILENAME_STRING](IMG_PROP_ANIMATION_ENCODER_CREATE_FILENAME_STRING)
isn't set.
...
the output file type, e.g. "webp", defaults to the file extension if [IMG_PROP_ANIMATION_ENCODER_CREATE_FILENAME_STRING](IMG_PROP_ANIMATION_ENCODER_CREATE_FILENAME_STRING)
is set.
