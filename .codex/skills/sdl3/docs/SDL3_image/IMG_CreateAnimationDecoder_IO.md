...
| --- | --- | --- |
| bool | closeio | true to close the SDL_IOStream when done, false to leave it
open. |
...
before returning if this function fails, or when the animation decoder
is closed if this function succeeds.
